...
export default function NotFound() {
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center">
            ...
            <Link href="/dashboard" className="bg-yellow-500 hover:bg-yellow-600 text-red-500 hover:text-red-600 px-8 py-3 rounded font-bold transition-colors duration-200">
